...
colors = {"background": "#3c364f", "text": "#000000"}
graphColor = {"background" : "green"}
                                ...
                                dbc.Container(
                                    [
                                        html.A(
                                            ...
                                            dbc.Row(
                                                [
                                                    dbc.Col(html.Img(src="https://dynamic.brandcrowd.com/preview/logodraft/16171d8c-1178-4d5d-a670-15ced9bcb7e8/image/large.png", height="60px")),
                                                    dbc.Col(dbc.NavbarBrand("Stock Visualization Web App", className="ms-4")),
                                                ],
                                                align="center",
                                                className="g-0",
                                                style={
                            ...
                            html.Header(
                                [
                                    html.H1(
                                        ...
                                        className="my-5 btn btn-primary text-center container mx-5 "
                                    )
                                ]
                            )
                        )
...
def graph_genrator(n_clicks, ticker, chart_name):
    ...
    if n_clicks >= 1:  # Checking for user to click submit button
        ...
        # loading data
        start_date = datetime.now().date() - timedelta(days=5 * 365)  #previous five year data
        ...
        if chart_name == "MACD":
            ...
            fig = go.Figure(
                data=[
                    go.Scatter(x=list(df.index), y=list(df.MACD), name="MACD", line=dict(color="green")),
